...
<%
	...
	for(JournalArticle article:articleList){
		String content=JournalContentUtil.getContent(themeDisplay.getScopeGroupId(), article.getArticleId(), template.getTemplateKey(), LiferayWindowState.NORMAL.toString(),
