...
import net.opentrends.studentdata.service.StudentMarksLocalService;
...
/**
 * Provides the base implementation for the student marks local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.opentrends.studentdata.service.impl.StudentMarksLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see net.opentrends.studentdata.service.impl.StudentMarksLocalServiceImpl
 * @see net.opentrends.studentdata.service.StudentMarksLocalServiceUtil
 * @generated
 */
public abstract class StudentMarksLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements StudentMarksLocalService,
        IdentifiableBean {
    ...
    private StudentMarksLocalServiceClpInvoker _clpInvoker = new StudentMarksLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link net.opentrends.studentdata.service.StudentMarksLocalServiceUtil} to access the student marks local service.
     */
    ...
    @Override
    public StudentMarks addStudentMarks(StudentMarks studentMarks)
        throws SystemException {
        studentMarks.setNew(true);

        return studentMarksPersistence.update(studentMarks);
    }
     ...
     */
    @Override
    public StudentMarks createStudentMarks(long markId) {
        return studentMarksPersistence.create(markId);
    }
    ...
    @Override
    public StudentMarks deleteStudentMarks(long markId)
        throws PortalException, SystemException {
        return studentMarksPersistence.remove(markId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public StudentMarks deleteStudentMarks(StudentMarks studentMarks)
        throws SystemException {
        return studentMarksPersistence.remove(studentMarks);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(StudentMarks.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return studentMarksPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return studentMarksPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public StudentMarks fetchStudentMarks(long markId)
        throws SystemException {
        return studentMarksPersistence.fetchByPrimaryKey(markId);
    }
     ...
     */
    @Override
    public StudentMarks getStudentMarks(long markId)
        throws PortalException, SystemException {
        return studentMarksPersistence.findByPrimaryKey(markId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return studentMarksPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<StudentMarks> getStudentMarkses(int start, int end)
        throws SystemException {
        return studentMarksPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getStudentMarksesCount() throws SystemException {
        return studentMarksPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public StudentMarks updateStudentMarks(StudentMarks studentMarks)
        throws SystemException {
        return studentMarksPersistence.update(studentMarks);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("net.opentrends.studentdata.model.StudentMarks",
            studentMarksLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = studentMarksPersistence.getDataSource();
