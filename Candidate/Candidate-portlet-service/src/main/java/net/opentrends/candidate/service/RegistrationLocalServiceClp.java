 ...
 * @generated
 */
public class RegistrationLocalServiceClp implements RegistrationLocalService {
    ...
    public RegistrationLocalServiceClp(
    ...
    public net.opentrends.candidate.model.Registration addRegistration(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(registration) });
        } catch (Throwable t) {
        ...
        return (net.opentrends.candidate.model.Registration) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<net.opentrends.candidate.model.Registration> getRegistrations(
        ...
        return (java.util.List<net.opentrends.candidate.model.Registration>) ClpSerializer.translateOutput(returnObj);
    }
