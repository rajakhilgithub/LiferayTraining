...
public class EmployeePortlet extends MVCPortlet {
	...
	public void editEmployeeAction(ActionRequest request,
			ActionResponse response) throws PortalException, SystemException,
			IOException, PortletException {
		Long employeeId = Long.parseLong(ParamUtil.getString(request,
				"employeeId"));
	...
	public void deleteEmployeeAction(ActionRequest request,
			ActionResponse response) throws PortalException, SystemException {
		Long employeeId = Long.parseLong(ParamUtil.getString(request,
				"deleteKey"));
		Employee employee = EmployeeLocalServiceUtil.getEmployee(employeeId);
	...
	public Long uploadFile(Employee employee, ActionRequest request,
			ActionResponse response) throws IOException, SystemException,
			PortalException, PortletException {
		...
		if (inputStream != null) {
			...
			String title = employee.getEmployeeName() + "-"
					+ employee.getEmployeeId() + " display pic";
			String description = "Display picture for "
	...
	public void createFolder(ThemeDisplay themeDisplay, ActionRequest request) {
		...
		if (!folderExist) {
			...
			try {
				...
				folder = DLAppServiceUtil.addFolder(repositoryId,
						PARENT_FOLDER_ID, DOCUMENT_FOLDER_NAME, FOLDER_DESC,
						serviceContext);
			} catch (PortalException | SystemException exception) {
				_log.error(exception.getMessage());
			}
	...
	public boolean folderExist(ThemeDisplay themeDisplay) {
		...
		long repositoryId = themeDisplay.getScopeGroupId();
		try {
			DLAppServiceUtil.getFolder(repositoryId, PARENT_FOLDER_ID,
					DOCUMENT_FOLDER_NAME);
			existResult = true;
	...
	public void updateFile(Employee employee, ActionRequest request,
