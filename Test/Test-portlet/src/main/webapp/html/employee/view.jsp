		...
		<td><aui:form method="post" action="<%=addEmployee%>"
				...
				<aui:layout>
					<aui:column columnWidth="50">
						<aui:input name="employeeName" type="text" label="Employee Name" value=""><aui:validator name="required" errorMessage="Enter employee name"/></aui:input>
						<aui:input name="houseName" type="text" label="House Name" value=""><aui:validator name="required" errorMessage="Enter house name"/></aui:input> 
						<aui:input name="street" type="text" label="Street" value=""><aui:validator name="required" errorMessage="Enter street"/></aui:input>
						<aui:input name="city" type="text" label="City" value=""><aui:validator name="required" errorMessage="Enter city"/></aui:input>
						...
						<aui:input name="pincode" label="Pincode" type="text" value=""><aui:validator name="required" errorMessage="Enter pincode"/>
					...
					<aui:column columnWidth="50">
						...
						<aui:input name="phone" label="Phone" type="text" value=""><aui:validator name="required" errorMessage="Enter phone"/>
						...
						<aui:input name="aadharNumber" label="Aadhar Number" type="text" value="">
						...
						<aui:input name="salary" label="Salary" type="text" value=""><aui:validator name="required" errorMessage="Enter salary"/>
						<aui:validator name="digits" errorMessage="Enter only digits"/>
						</aui:input>
					</aui:column>
				</aui:layout>
