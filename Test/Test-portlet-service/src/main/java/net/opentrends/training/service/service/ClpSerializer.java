...
import net.opentrends.training.service.model.EmployeeClp;
...
public class ClpSerializer {
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals(
                    "net.opentrends.training.service.model.impl.EmployeeImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals(
            ...
            return new net.opentrends.training.service.NoSuchEmployeeException();
        }
